        ...
        <div class="card-body">
            <form action="{{ route('mahasiswa.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="NRP" class="@error('NRP') is-invalid @enderror form-control" value="{{ old('NRP') }}" placeholder="Masukan NRP" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="Kelas" class="form-control" value="{{ old('Kelas') }}" placeholder="Masukan Kelas" required>
                </div>

                <div class="form-group mb-3">
                    <label for="Jenis_Kelamin">Jenis Kelamin</label>
                    <input type="text" name="Jenis_Kelamin" class="form-control" value="{{ old('Jenis_Kelamin') }}" placeholder="Masukan Jenis Kelamin" required>
                </div>

                <div class="form-group mb-3">
                    <label for="Tanggal_Lahir">Tanggal Lahir</label>
                    <input type="date" name="Tanggal_Lahir" class="form-control" value="{{ old('Tanggal_Lahir') }}" placeholder="Masukan Tanggal Lahir" required>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="file" name="dokumen" class="form-control" value="{{ old('dokumen') }}" placeholder="Masukan Dokumen" required>
                </div>
